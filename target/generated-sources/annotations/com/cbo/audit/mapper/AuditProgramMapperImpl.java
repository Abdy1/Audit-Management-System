...
public class AuditProgramMapperImpl implements AuditProgramMapper {
    ...
    public void copyToDTO(AuditProgram auditProgram, AuditProgramDTO auditProgramDTO) {
        ...
        if ( auditProgram.getAuditSchedule() != null ) {
            if ( auditProgramDTO.getAuditSchedule() == null ) {
                auditProgramDTO.setAuditSchedule( new AuditScheduleDTO() );
            }
            auditScheduleToAuditScheduleDTO1( auditProgram.getAuditSchedule(), auditProgramDTO.getAuditSchedule() );
        }
        else {
            auditProgramDTO.setAuditSchedule( null );
        }
    }
